...
同時，注意到本標準中規定的字形和 CJK 中 G 源（大陸提供字形）存在差異。在使用大陸字體時，會出現部分部首不一致的現象，如`吳誤` `碌彔`。因此，《古籍》字形的使用需要配合特殊字體。遺憾的是，此類字體未有問世。因此上，我基於《通用規範漢字表》、上海古籍出版社二〇一九年第二版《文選》，參考《古籍印刷通用字規範字形表》，以通規爲主，以古籍爲輔，生成**調和大陸繁體標準**，部首不一致的情況。配置名爲 s2c.json。
...
| -------- | -------- | -------- | -------- | ---------- | --------------------------------- |
| 朵       | 朶       | 朵〔朶〕 | 朵       |            | 部分字無獨立碼位                  |
| 吕       | 呂       | 吕       | 呂       | 侣宫營閭   | 「營閭」等字無獨立碼位            |
| 皀       | 皀、〔即左〕| 〔即左〕 | 〔即左〕 | 卽旣       | 「鄉」不一致 <br>「節」無獨立碼位 |
| 录       | 彔       | 录       | 彔       | 綠淥剝錄祿 | 「碌箓」等字無獨立碼位            |
| 吴       | 吳       | 吴       | 吳       | 誤娱       | 「誤」等字無獨立碼位              |
| 黄       | 黃       | 黄       | 黃       | 廣璜       | 「廣璜」等字無獨立碼位            |
| 〔温右〕 | 〔溫右〕 | 昷       | 〔溫右〕 | 温愠       |                                   |
<!-- do not translate -->
...
| -------- | -------- | ---------- | -------- | ------------------------------------------ |
| 廈       | 厦       | 厦〔廈〕   | 廈       | 《辭源》慣用字爲「廈」<br>「厂」字頭不一致 |
| 艷       | 艶       | 艷〔豓豔〕 | 豔       | 《辭源》慣用字爲「艷」                     |
| 灧       | 灔       | 灧         | 灩       |                                            |
| 床       | 牀       | 床〔牀〕   | 床       | 古籍通規未收「床」字                       |
<!-- do not translate -->
